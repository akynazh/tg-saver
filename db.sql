...
DROP TABLE IF EXISTS t_tg_nice_jav_daily;
CREATE TABLE t_tg_nice_jav_daily
(
    av_id         TEXT,
    msg_id        INTEGER,
    file_id       TEXT,
...
CREATE INDEX idx_t_tg_nice_jav_daily_av_id ON t_tg_nice_jav_daily (av_id);
CREATE INDEX idx_t_tg_nice_jav_daily_file_id ON t_tg_nice_jav_daily (file_id);
CREATE INDEX idx_t_tg_nice_jav_daily_ori_msg ON t_tg_nice_jav_daily (ori_chat_name, file_type, ori_msg_id);
